// src/app/api/cases/[caseId]/documents/[requirementId]/submissions/route.ts
...
// Reuse the same store instance from the parent route
class CaseStore {
...
export async function POST(
  ...
  const { caseId, requirementId } = await params;
